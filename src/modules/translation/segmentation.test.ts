...
describe('segmentation', () => {
  ...
  it('never splits in the middle of a surrogate pair', () => {
    // Fill a segment past the boundary with an emoji (surrogate pair) exactly
    // straddling the split point, with no sentence boundary characters.
    const emoji = '😀';
    ...
    // Every code point must remain a complete emoji (no lone surrogate).
